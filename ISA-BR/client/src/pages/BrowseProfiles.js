        ...
        <Col>
          <Card bg="info">
            <Card.Body>
              ...
              <Card.Text>IsaacsDanks{user.username}</Card.Text>
              <Card.Text>City:El Cajon {user.city}</Card.Text>
        ...
        <Col>
          <Card bg="light">
            <Card.Body>
              ...
              <Card.Text>FaostosBurritos</Card.Text>
        ...
        <Col>
          <Card bg="info">
            <Card.Body>
              ...
              <Card.Text>PaolasPastries</Card.Text>
              <Card.Text>City: El Cajon</Card.Text>
              <Card.Link as={Link} to="/view-profiles/:userId">
                View Profile
              </Card.Link>
        ...
        <Col>
          <Card bg="#FFF9C4">
            <Card.Body>
              ...
              <Card.Text>ZethsZingers</Card.Text>
              <Card.Text>City: El Cajon</Card.Text>
              <Card.Link as={Link} to="/view-profiles/:userId">
                View Profile
              </Card.Link>
        ...
        <Col>
          <Card bg="info">
            <Card.Body text="light">
              ...
              <Card.Text>JohnsJumbalaya</Card.Text>
              <Card.Text>City: El Cajon</Card.Text>
              <Card.Link as={Link} to="/view-profiles/:userId">
                View Profile
              </Card.Link>
